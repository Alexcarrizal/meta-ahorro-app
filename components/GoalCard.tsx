...
const getGoalColorStyles = (color: string) => {
    const colorMap: { [key: string]: { [key: string]: string } } = {
        emerald: {
            ...
            category: 'bg-emerald-100 text-emerald-800 border-emerald-200 dark:bg-emerald-500/20 dark:text-emerald-400 dark:border-emerald-500/30',
            projectionBg: 'bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-500/10 dark:hover:bg-emerald-500/20',
            ...
            completedBg: 'bg-emerald-100 dark:bg-emerald-500/20',
        },
        sky: {
            ...
            category: 'bg-sky-100 text-sky-800 border-sky-200 dark:bg-sky-500/20 dark:text-sky-400 dark:border-sky-500/30',
            projectionBg: 'bg-sky-50 hover:bg-sky-100 dark:bg-sky-500/10 dark:hover:bg-sky-500/20',
            ...
            completedBg: 'bg-sky-100 dark:bg-sky-500/20',
        },
        amber: {
            ...
            category: 'bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-500/20 dark:text-amber-400 dark:border-amber-500/30',
            projectionBg: 'bg-amber-50 hover:bg-amber-100 dark:bg-amber-500/10 dark:hover:bg-amber-500/20',
            ...
            completedBg: 'bg-amber-100 dark:bg-amber-500/20',
        },
        rose: {
            ...
            category: 'bg-rose-100 text-rose-800 border-rose-200 dark:bg-rose-500/20 dark:text-rose-400 dark:border-rose-500/30',
            projectionBg: 'bg-rose-50 hover:bg-rose-100 dark:bg-rose-500/10 dark:hover:bg-rose-500/20',
            ...
            completedBg: 'bg-rose-100 dark:bg-rose-500/20',
        },
        indigo: {
            ...
            category: 'bg-indigo-100 text-indigo-800 border-indigo-200 dark:bg-indigo-500/20 dark:text-indigo-400 dark:border-indigo-500/30',
            projectionBg: 'bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-500/10 dark:hover:bg-indigo-500/20',
            ...
            completedBg: 'bg-indigo-100 dark:bg-indigo-500/20',
        },
        purple: {
            ...
            category: 'bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-500/20 dark:text-purple-400 dark:border-purple-500/30',
            projectionBg: 'bg-purple-50 hover:bg-purple-100 dark:bg-purple-500/10 dark:hover:bg-purple-500/20',
            ...
            completedBg: 'bg-purple-100 dark:bg-purple-500/20',
        },
    };
      ...
      <div>
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => onDelete(goal.id)} className="text-gray-400 hover:text-red-500 dark:text-gray-500 dark:hover:text-red-400 p-1 rounded-full transition-colors">
