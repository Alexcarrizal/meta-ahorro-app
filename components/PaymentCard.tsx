...
const PaymentCard = ({ payment, onTogglePaid, onEdit, onDelete }: PaymentCardProps) => {
  ...
  return (
    <div className={`bg-white dark:bg-gray-800/50 border border-sky-200 dark:border-sky-800/40 rounded-xl p-6 flex flex-col justify-between hover:border-sky-400 dark:hover:border-sky-500/50 transition-all duration-300 ${isPaid ? 'opacity-60 dark:opacity-50' : ''}`}>
      <div>
      ...
      <div className="mt-auto">
         <button 
            ...
            className={`w-full text-center font-semibold py-2 px-4 rounded-lg transition-colors ${isPaid ? 'bg-gray-200 dark:bg-gray-600 text-gray-500 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-500' : 'bg-sky-500 text-black hover:bg-sky-400'}`}>
